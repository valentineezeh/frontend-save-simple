 ...
 */
class EthicalSavings extends Component {
    state = {
      title: '',
      description: '',
      maturityDate: '',
  ...
  onClickNextButton = () => {
    ...
    if (this.isValid()) {
      if (fundingSource === '1') {
        Cookies.set('newEthSavingObj', ethicalSavingsPayload);
        Cookies.set('actionType', actionType);
        const { history } = this.props;
        return history.push('/add-card');
      }
      if (fundingSource === '2') {
        this.setState({
          errors: {},
      ...
      if (fundingSource === '5') {
        CreateFixedTargetSavings(ethicalSavingsPayload);
      }
    }
  }
...
Target Amount
              ...
              ₦
                  ...
                  <div className="input_div">
                    <TextField
                      ...
                      value={title || ''}
                      field="title"
                      placeholder="Title of ethical savings"
                      label="Title"
                    />
                  </div>
                  ...
                  <div className="input_div">
                    ...
                    {errors && <p className="text-danger">{errors.fundingSource}</p>}
                  </div>
                  <div className="input_div">
                    <TextField
  ...
  Please Select a Funding Source
          ...
          <div className="btn_full_width green_btn">
            {
              isEmpty(customerCards.customerCards) ? '' : createTargetLoading ? (
                <Button
